...
Recommended readings: "Becoming a Technical Leader" by Gerald M. Weinberg; "Accelerate: Building and Scaling High Performing Technology Organizations" by Nicole Forsgren, Jez Humble, and Gene Kim
...
Recommended readings: "Fundamentals of Software Architecture" by Mark Richards and Neal Ford; "Software Architecture: The Hard Parts" by Neal Ford and Mark Richards
...
- **T-shaped skills** - broad knowledge across multiple areas (architecture, DevOps, cloud, security, etc.).
  ...
  - Focus on "stuff you don't know you don't know" to expand your knowledge and skills beyond your current expertise (e.g., read InfoQ articles, check Thoughtworks Tech Radar, attend conferences, etc.).
...
Recommended readings: [Expert Generalist](https://martinfowler.com/articles/expert-generalist.html) by Martin Fowler; "Atomic Habits" by James Clear
...
Recommended readings: "The Staff Engineer’s Path" by Tanya Reilly; ["How to Manage Your Time as a Software Engineer – 5 Practical Tips and Tools"](https://handsonarchitects.com/blog/2024/how-to-manage-your-time-as-software-engineer-5-practial-tips-and-tools/) by Handson Architects; "Deep Work: Rules for Focused Success in a Distracted World" by Cal Newport
...
- [Pathfinder Engineer blog](https://pathfinderengineer.substack.com/)